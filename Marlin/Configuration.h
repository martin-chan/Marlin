...
#define STRING_CONFIG_H_AUTHOR "(orangehk, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "NFP-3D-Printer"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1287.08, 1287.08, 402.21, 101.86 }
...
#define LCD_FEEDBACK_FREQUENCY_HZ 326
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS 153  // Initial brightness (0-255)
  ...
  #define NEOPIXEL_BKGD_LED_INDEX  29               // Index of the LED to use
  #define NEOPIXEL_BKGD_COLOR { 255, 147, 41, 0 } // R, G, B, W
#endif
